  ...
  const repertoireCatalogSeed = [
    {
      ...
      tags: "demo,piano,balada",
    },
    {
      id: "catalog_demo_stand_by_me",
      title: "Stand by Me",
    ...
    },
    {
      ...
      tags: "demo,piano,clásico",
    },
    {
      id: "catalog_demo_count_on_me",
      title: "Count on Me",
    ...
    },
    {
      ...
      tags: "demo,voice,balada",
    },
    {
      id: "catalog_demo_can_you_feel_the_love",
      ...
      tags: "demo,voice,disney",
    },
    {
      id: "catalog_demo_minuet_in_g",
      title: "Minuet in G",
    ...
    },
    {
      ...
      tags: "demo,voice,latino",
    },
  ] as const;

  await Promise.all(repertoireCatalogSeed.map((item) => prisma.repertoireCatalogItem.upsert({
    where: { id: item.id },
    update: {
      title: item.title,
    ...
    create: {
      ...
      active: true,
      createdByUserId: adminUser.id,
      defaultTeacherNotes: "Canción demo para probar búsqueda y asignación de repertorio.",
      defaultStudentVisibleNotes: "Trabajar por secciones cortas con práctica constante.",
    },
  })));
